...
import com.example.getphone.Admin.AdminMaintainProductsActivity;
import com.example.getphone.AllCategories;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //   navigationView.setItemTextColor(ColorStateList.valueOf(getResources().getColor(R.color.)));
